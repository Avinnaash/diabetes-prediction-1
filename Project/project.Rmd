...
auc.list <-c(auc.lm, auc.ridge, auc.lasso, auc.gam.poly, auc.gam.bs, auc.gam.ns, auc.lda, auc.qda, auc.svm.linear, auc.svm.radial, auc.tree, auc.boosting)
...
plot(perf)
abline(a=0, b= 1)
title(paste("Logistic Regression - AUC:",round(auc.gam.poly,4)))
```
